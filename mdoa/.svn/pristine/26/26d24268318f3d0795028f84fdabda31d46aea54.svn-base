...
public class CountMonthBalanceForm {
	...
	public String toString() {
		return "CountMonthBalanceForm [goodsMonthBalanceId=" + goodsMonthBalanceId + ", goodsId=" + goodsId
				+ ", goodsName=" + goodsName + ", movingAverPrice=" + movingAverPrice + ", weightedAverPrice="
				+ weightedAverPrice + ", goodsSize=" + goodsSize + ", monthBalanceTime=" + monthBalanceTime
