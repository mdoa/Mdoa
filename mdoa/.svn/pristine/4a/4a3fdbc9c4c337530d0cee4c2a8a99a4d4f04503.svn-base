$(function(){
	...
	$('#trainDoc .traindg').datagrid({
	 //   url:'../../train/queryTrainPersonMessage.do?getMs='+getMS(),
	    method:"post",
	    columns:[[
	        {field:'userName',title:'员工名',width:75},
			...
			{field:'trainDescribe',title:'培训描述',width:100,align:'center'},
			{field:'train_company',title:'培训公司',align:'center',width:100,formatter:function(value,row,index){
