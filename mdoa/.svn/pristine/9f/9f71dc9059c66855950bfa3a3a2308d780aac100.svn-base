	...
	$('#gooutdg').datagrid({
		   ...
		   columns:[[
		      // {field:"ck",checkbox:true },
		       ...
		       {field:"goOutUserName",title:"外出人姓名",fitColumns:true,resizable:true,align:"center",sortable:true,width:75},
		       ...
		       {field:"backFlag",title:"是否返回",fitColumns:true,resizable:true,align:"center",width:60,sortable:true,formatter:function(value,row,index){
		    	   if(value == '0'){
		    		   return '未返回';
		    	   }else if(value == '1'){
		    		   return '已返回';
		       ...
		       {field:"recordUserName",title:"备案人姓名",fitColumns:true,resizable:true,width:75,align:"center",sortable:true},
		       {field:"recordIdea",title:"备案意见",fitColumns:true,resizable:true,align:"center",width:150,sortable:true},
		       {field:"recordTimeStr",title:"备案时间",fitColumns:true,resizable:true,align:"center",width:130,sortable:true},
		       {field:"examineStatus",title:"审核状态",fitColumns:true,resizable:true,align:"center",width:60,sortable:true,formatter:function(value,row,index){
		    	   if(value == '1'){
		    		   return '待审';
		    	   }else if(value == '2'){
		    		   return '撤回';
