$(function(){
	...
	$('#trainflow .traindg').datagrid({
	    ...
	    method:"post",
	    columns:[[
			{field:'trainName',title:'培训名称',width:100},
			{field:'trainReason',title:'培训原因',width:100},
			{field:'startTimeStr',title:'培训开始时间',width:100,align:'right'},
			{field:'endTimeStr',title:'培训结束时间',width:100,align:'right'},
			{field:'trainDetail',title:'培训描述',width:100,align:'center'},
			{field:'apply_state',title:'审批状态',width:100,align:'center',formatter:function(value,row,index){
				 return getValueFromKey("apply_state",row.applyState);
			}},
			{field:'examine_status',title:'我的审批',width:100,align:'center',formatter:function(value,row,index){
				 return getValueFromKey("examine_status",row.examineStatus);
			}},
			{field:'examineTimeStr',title:'审批时间',width:100,align:'center'},
			{field:'createTimeStr',title:'申请审批时间',width:100,align:'center'},
