 ...
 *
 */
public class RepertoryWeightedAverPrice {

	private String weightedAverPriceId;
	...
	public String getWeightedAverPriceId() {
		return weightedAverPriceId;
	}
	public void setWeightedAverPriceId(String weightedAverPriceId) {
		this.weightedAverPriceId = weightedAverPriceId;
	}
