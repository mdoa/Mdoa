...
/**
 * @description 流程人员设置管理(2.2.1 版本不使用)
 * @class ProUserAssign
 * @author 宏天软件
 * @updater YHZ
...
public class ProUserAssign extends com.htsoft.core.model.BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.assignId, rhs.assignId)
				.append(this.deployId, rhs.deployId)
				.append(this.activityName, rhs.activityName)
				.append(this.roleId, rhs.roleId)
				.append(this.userId, rhs.userId).append(this.jobId, rhs.jobId)
				.append(this.jobName, rhs.jobName)
				.append(this.reJobId, rhs.reJobId)
				.append(this.reJobName, rhs.reJobName)
				.append(this.isSigned, rhs.isSigned)
				.append(this.depIds, rhs.depIds)
				.append(this.depNames, rhs.depNames)
				.append(this.posUserFlag, rhs.posUserFlag).isEquals();
	}
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.assignId)
				.append(this.deployId).append(this.activityName)
				.append(this.roleId).append(this.userId).append(this.jobId)
				.append(this.jobName).append(this.reJobId)
				.append(this.reJobName).append(this.isSigned)
				.append(this.depIds).append(this.depNames)
				.append(this.posUserFlag).toHashCode();
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("assignId", this.assignId)
				...
				.append("roleId", this.roleId).append("userId", this.userId)
				.append("jobId", this.jobId).append("jobName", this.jobName)
				.append("reJobId", this.reJobId)
				.append("reJobName", this.reJobName)
				.append("isSigned", this.isSigned)
				.append("depIds", this.depIds)
				.append("depNames", this.depNames)
				.append("posUserFlag", this.posUserFlag).toString();
	}
