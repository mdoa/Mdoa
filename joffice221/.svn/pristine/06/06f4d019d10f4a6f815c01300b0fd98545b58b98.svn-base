Ext.ns('HaveOpenConferenceView');
/**
 * @class HaveOpenConferenceView
 * @extends Ext.Panel
 * @description 已开会议查询
 * @company 杭州梦德软件有限公司
 */
HaveOpenConferenceView = Ext.extend(Ext.Panel, {
	// 构造函数
	constructor : function(_cfg) {
		...
		// 调用父类构造
		HaveOpenConferenceView.superclass.constructor.call(this, {
					id : 'HaveOpenConferenceView',
					title : '已开会议查询',
					iconCls : 'menu-conference_haveOpen',
					region : 'center',
					layout : 'border',
	...
	initUIComponents : function() {
		...
		this.gridPanel = new HT.GridPanel({
					...
					// 使用RowActions
					rowActions : true,
					url : __ctxPath + "/admin/haveOpenConference.do",
					fields : [ {
						name : 'confId',
						type : 'int'
