...
/**
 * DepreRecord Base Java Bean, base class for the.oa.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * TODO: add class/table comments
 */
public class DepreRecord extends com.htsoft.core.model.BaseModel {
	...
	protected com.htsoft.oa.model.admin.FixedAssets fixedAssets;
	...
	public com.htsoft.oa.model.admin.FixedAssets getFixedAssets () {
		return fixedAssets;
	}	
	
	public void setFixedAssets (com.htsoft.oa.model.admin.FixedAssets in_fixedAssets) {
	...
	public void setAssetsId(Long aValue) {
	    if (aValue==null) {
	        ...
	        fixedAssets = new com.htsoft.oa.model.admin.FixedAssets(aValue);
