/**
 * Created with JetBrains PhpStorm. User: taoqili Date: 12-6-12 Time: 下午5:02 To
...
UE.I18N['zh-cn'] = {
	...
	'edittd' : {
		'_static' : {
			...
			lang_vertical : "垂直",
			vAlign : {
				options : ["默认", "居中对齐", "顶端对齐", "底部对齐"]
			},
			align : {
				options : ["默认", "居中对齐", "左对齐", "右对齐"]
			}
		},
		clearColor : "清除颜色"
	},
