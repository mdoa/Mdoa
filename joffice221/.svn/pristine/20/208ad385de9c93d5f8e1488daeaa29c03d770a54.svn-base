...
/**
 * GoodsApply Base Java Bean, base class for the.oa.model, mapped directly to
 * database table
 * 
 ...
 * 商品申请
 */
public class GoodsApply extends com.htsoft.core.model.BaseModel {
	...
	protected com.htsoft.oa.model.admin.OfficeGoods officeGoods;

	/**
	 * 通过审批
	 */
	public static short PASS_APPLY = 2;
	/**
	 * 未通过审批
	 */
	public static short NOTPASS_APPLY = 3;
	...
	public com.htsoft.oa.model.admin.OfficeGoods getOfficeGoods() {
		return officeGoods;
	}

	public void setOfficeGoods(
			com.htsoft.oa.model.admin.OfficeGoods in_officeGoods) {
	...
	public Long getGoodsId() {
		return this.getOfficeGoods() == null ? null : this.getOfficeGoods()
				.getGoodsId();
	}
	...
	public void setGoodsId(Long aValue) {
		if (aValue == null) {
			...
			officeGoods = new com.htsoft.oa.model.admin.OfficeGoods(aValue);
			officeGoods.setVersion(new Integer(0));// set a version to cheat
													// hibernate only
		} else {
	 ...
	 * 
	 * @hibernate.property column="applyDate" type="java.util.Date" length="19"
	 ...
	 * 
	 * @hibernate.property column="applyNo" type="java.lang.String" length="128"
	 *                     not-null="true" unique="false"
	 */
	 ...
	 * 
	 * @hibernate.property column="useCounts" type="java.math.BigDecimal"
	 *                     length="18" not-null="true" unique="false"
	 */
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="notes" type="java.lang.String" length="500"
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.applyId, rhs.applyId)
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.applyId)
				.append(this.applyDate).append(this.applyNo)
				.append(this.useCounts).append(this.proposer)
				.append(this.userId).append(this.notes)
				.append(this.approvalStatus).toHashCode();
	}
