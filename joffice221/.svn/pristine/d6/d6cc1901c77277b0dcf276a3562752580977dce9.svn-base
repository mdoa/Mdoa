...
UE.I18N['en'] = {
	'labelMap' : {
		...
		'depselector' : 'DepartmentSelector',
	...
	inserttable : {
		'_static' : {
			...
			align : {
				options : ["Default", "Justify", "Justify Left",
						"Justify Right"]
			},
			borderType : {
				options : ["Only table", "All cells"]
			},
	...
	edittd : {
		'_static' : {
			...
			lang_vertical : "V",
			vAlign : {
				options : ["Default", "Justify", "Justify Top",
						"Justify Bottom"]
			},
			align : {
				options : ["Default", "Justify", "Justify Left",
	...
	'hidedomain' : {
		'_static' : {
			'lang_fieldName' : 'FieldName',
			'lang_fieldDesc' : 'FieldDesc',
			'lang_dataType' : 'DataType',
			'lang_dataFormat' : 'DataFormat',
			'lang_options' : 'Options',
			'lang_required' : 'Required',
			'lang_list' : 'ShowList',
			'lang_flowTitle' : 'FlowTitle',
			'lang_query' : 'As QueryCondition',
			dbType : {
				options : ["varchar", "number", "date", "longText"]
			},
			'lang_queryCondition' : 'QueryCondition',
			'lang_condition' : 'Condition',
			'lang_valueSources' : 'ValueSources',
			'lang_searchValue' : 'Value',
			queryCondition : {
				options : ["equal", "LIKE", "LIKEEND"]
			},
			valueSources : {
				options : ["表单输入", "固定值", "脚本"]
			}
	...
	'textfield' : {
		'_static' : {
			...
			'lang_queryCondition' : '查询条件',
			'lang_condition' : '条件',
			'lang_valueSources' : '值来源',
			'lang_searchValue' : '值',
			queryCondition : {
				options : ["等于", "LIKE", "LIKEEND"]
			},
			valueSources : {
				options : ["表单输入", "固定值", "脚本"]
			}
	...
	'checkbox' : {
		'_static' : {
			...
			'lang_query' : '作为查询条件',
			'lang_validRule' : '验证规则',
			'lang_options_text' : '复选框选项',
			'lang_options_comment' : '每行对应一个子项',
			dbType : {
				options : ["字符", "数字", "大文本"]
			},
			'lang_queryCondition' : '查询条件',
	...
	'subtable' : {
		'_static' : {
			'lang_tablekey' : '明细表名称',
			'lang_tablename' : '明细表描述',
			'lang_tablerows' : '列数',
			'lang_datamodel' : '添加数据模式',
			'lang_inlinemodel' : '行模式',
			'lang_blockmodel' : '块模式',
			'lang_windowmodel' : '弹窗模式'
		}
	},
	'inputDialog' : {
		'loadRule' : '正在加载验证规则...',
		'loadError' : '加载验证失败，请刷新页面.',
		'not' : '无',
		'length' : '长度',
		'integer' : '整数位',
		'decimal' : '小数位',
