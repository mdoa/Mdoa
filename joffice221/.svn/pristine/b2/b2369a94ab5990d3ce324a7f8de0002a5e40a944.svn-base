...
/**
 * ProHandleComp Base Java Bean, base class for the.oa.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * 
 */
public class ProHandleComp extends com.htsoft.core.model.BaseModel {
	/**
	 * 实现listener接口
	 */
