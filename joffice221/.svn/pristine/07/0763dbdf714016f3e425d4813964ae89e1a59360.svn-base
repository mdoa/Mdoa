...
/**
 * Archives Base Java Bean, base class for the.oa.model, mapped directly to
 * database table
 * 
...
public class Archives extends com.htsoft.core.model.BaseModel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4136807625628075363L;
	/**
	 * 公文状态--草稿
	 */
	...
	@Expose
	protected com.htsoft.oa.model.system.GlobalType archivesType;// 发文类型
	@Expose
	protected com.htsoft.oa.model.system.GlobalType archivesRecType;// 收文类型
	@Expose
	...
	@Expose
	@JsonBackReference
	protected java.util.Set archivesDocs = new HashSet();
	@JsonBackReference
	protected java.util.Set archivesDispatch = new HashSet();

	public java.util.Set getArchivesDispatch() {
	 ...
	 * * @return Long
	 * 
	 * @hibernate.id column="archivesId" type="java.lang.Long"
	...
	public void setTypeId(Long aValue) {
		if (aValue == null) {
			...
			archivesType.setVersion(new Integer(0));// set a version to cheat
													// hibernate only
		} else {
	...
	public Long getRecTypeId() {
		return this.getArchivesRecType() == null ? null : this
				.getArchivesRecType().getProTypeId();
	}
	...
	public void setRecTypeId(Long aValue) {
		if (aValue == null) {
			...
			archivesRecType.setVersion(new Integer(0));// set a version to cheat
														// hibernate only
		} else {
	 ...
	 * 发文字号 * @return String
	 * 
	 * @hibernate.property column="archivesNo" type="java.lang.String"
	 ...
	 * 
	 * @hibernate.property column="issueDate" type="java.util.Date" length="19"
	 *                     not-null="true" unique="false"
	 */
	...
	/**
	 * 公文状态 0=拟稿、修改状态 1=发文状态 2=归档状态 * @return Short
	 * 
	 ...
	 * 文件数 * @return Integer
	 * 
	 * @hibernate.property column="fileCounts" type="java.lang.Integer"
	...
	/**
	 * 秘密等级 普通 秘密 机密 绝密 * @return String
	 * 
	 * @hibernate.property column="privacyLevel" type="java.lang.String"
	...
	/**
	 * 紧急程度 普通 紧急 特急 特提 * @return String
	 * 
	 * @hibernate.property column="urgentLevel" type="java.lang.String"
	 *                     length="50" not-null="false" unique="false"
	 */
	 ...
	 * 发文人 * @return String
	 * 
	 * @hibernate.property column="issuer" type="java.lang.String" length="50"
	 ...
	 * 发文人ID * @return Long
	 * 
	 * @hibernate.property column="issuerId" type="java.lang.Long" length="19"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * 主题词 * @return String
	 * 
	 * @hibernate.property column="keywords" type="java.lang.String"
	...
	/**
	 * 公文来源 仅在收文中指定，发公文不需要指定 上级公文 下级公文 * @return String
	 * 
	 * @hibernate.property column="sources" type="java.lang.String" length="50"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * * @return Short
	 * 
	 * @hibernate.property column="archType" type="java.lang.Short" length="5"
	 *                     not-null="true" unique="false"
	 */
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.archivesId, rhs.archivesId)
				...
				.append(this.runId, rhs.runId).isEquals();
	}
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973)
				...
				.append(this.orgArchivesId).append(this.depSignNo)
				.append(this.runId).toHashCode();
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("archivesId", this.archivesId)
				...
				.append("runId", this.runId).toString();
	}
