...
/**
 * FormTemplate Base Java Bean, base class for the.oa.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * TODO: add class/table comments
 */
public class FormTemplate extends com.htsoft.core.model.BaseModel {
	/**
	 * TempType 1=Ext模板
	 * 2=Url模板
	 */
