...
/**
 * ContractConfig Base Java Bean, base class for the.oa.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * ���������������
 */
public class ContractConfig extends com.htsoft.core.model.BaseModel {
	...
	protected com.htsoft.oa.model.customer.Contract contract;
	...
	public com.htsoft.oa.model.customer.Contract getContract () {
		return contract;
	}	
	
	public void setContract (com.htsoft.oa.model.customer.Contract in_contract) {
	...
	public void setContractId(Long aValue) {
	    if (aValue==null) {
	        ...
	        contract = new com.htsoft.oa.model.customer.Contract(aValue);
