...
/**
 * PlanAttend Base Java Bean, base class for the.oa.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * TODO: add class/table comments
 */
public class PlanAttend extends com.htsoft.core.model.BaseModel {

    protected Long attendId;
	protected Short isDep;
	protected Short isPrimary;
	@JsonManagedReference
	protected com.htsoft.oa.model.task.WorkPlan workPlan;
	@JsonManagedReference
	...
	public com.htsoft.oa.model.task.WorkPlan getWorkPlan () {
		return workPlan;
	}	
	
	public void setWorkPlan (com.htsoft.oa.model.task.WorkPlan in_workPlan) {
	...
	public void setPlanId(Long aValue) {
	    if (aValue==null) {
	        ...
	        workPlan = new com.htsoft.oa.model.task.WorkPlan(aValue);
