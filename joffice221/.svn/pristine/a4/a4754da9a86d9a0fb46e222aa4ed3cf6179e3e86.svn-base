<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.List,com.htsoft.core.util.AppUtil" %>
<%@ page import="com.htsoft.oa.model.system.GlobalType" %>
<%
	String basePath = request.getContextPath();
	String uId = request.getAttribute("uId").toString();
	String postUrl = basePath + "/flow/flexDefSaveProDefinition.do";
	String flowKeyGetUrl = basePath+"/flow/getDefKeyByNameProDefinition.do";
	String flowListGetUrl = basePath+"/flow/getFlowListProDefinition.do";
%>
<%
    // 获取流程类型,加载下拉框
    @SuppressWarnings("unchecked")
	String record = request.getAttribute("record").toString();
%>
<!-- 加载数据操作 -->
