Ext.ns('TemporaryConferenceView');
/**
 * @class TemporaryConferenceView
 * @extends Ext.Panel
 * @description 暂存会议查询
 * @company 杭州梦德软件有限公司
 */
TemporaryConferenceView = Ext.extend(Ext.Panel, {
	// 构造函数
	constructor : function(_cfg) {
		...
		// 调用父类构造
		TemporaryConferenceView.superclass.constructor.call(this, {
					id : 'TemporaryConferenceView',
					title : '暂存会议查询',
					iconCls : 'menu-conference_temporary',
					region : 'center',
					layout : 'border',
	...
	initUIComponents : function() {
		...
		this.gridPanel = new HT.GridPanel({
			 		id : 'TemporaryConferenceGrid',
					region : 'center',
					tbar : this.topbar,
					sort : [{field:"confId",direction:"DESC"}],
					// 使用RowActions
					rowActions : true,
					url : __ctxPath + "/admin/temporaryConference.do",
					fields : [ {
						name : 'confId',
						type : 'int'
