...
VALUES (1,'admin',1,'a4ayc/80/OGda4BO/1o/V0etpOqiLx1JwB5S3beHW0s=','csx@jee-soft.cn',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,sysdate,1,NULL,'超级管理员',0);

INSERT INTO app_user (USERID,USERNAME,TITLE,PASSWORD,EMAIL,DEPID,JOBID,PHONE,MOBILE,FAX,ADDRESS,ZIP,PHOTO,ACCESSIONTIME,STATUS,EDUCATION,FULLNAME,DELFLAG) 
VALUES (-1,'system',1,'0','152@163.com',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,to_date('2009-12-18','yyyy-mm-dd'),0,NULL,'系统',1);
...
-- 添加组织
--insert into organization values (1,'宏天软件',0,'0.1.',0,null,1,sysdate,1,sysdate,'宏天软件');
--insert into organization values (1,1,'宏天软件','宏天软件',0,'0.1.',0,null,1,sysdate,1,sysdate);
insert into ORGANIZATION (ORG_ID,DEM_ID,ORG_NAME,ORG_DESC,ORG_SUP_ID,PATH,DEPTH,ORG_TYPE,CREATOR_ID,CREATETIME,UPDATE_ID,UPDATETIME) values (1,1,'宏天软件','宏天软件',0,'0.1.',1,1,1,to_date('21-01-2013 14:02:02', 'dd-mm-yyyy hh24:mi:ss'),1,to_date('21-01-2013 14:02:02', 'dd-mm-yyyy hh24:mi:ss'));
