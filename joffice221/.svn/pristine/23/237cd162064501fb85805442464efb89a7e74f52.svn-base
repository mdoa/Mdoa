package com.htsoft.oa.core.json;
...
/**
 * java日期对象经过Jackson库转换成JSON日期格式化（yyyy-MM-dd HH:mm:ss）自定义类
 * 
 * 
 * <pre>
 *  例子：
...
public class JacksonDateTimeSerializer extends JsonSerializer<Date> {
	...
	public void serialize(Date value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
		jgen.writeString(DateFormatUtil.format(value, Constants.DATE_FORMAT_FULL));
	}
}