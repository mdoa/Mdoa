 ...
 */
public class Contract extends com.htsoft.core.model.BaseModel {
	...
	@Expose
	protected com.htsoft.oa.model.customer.Project project;
	...
	public com.htsoft.oa.model.customer.Project getProject () {
		return project;
	}	
	
	public void setProject (com.htsoft.oa.model.customer.Project in_project) {
	...
	public void setProjectId(Long aValue) {
	    if (aValue==null) {
	        ...
	        project = new com.htsoft.oa.model.customer.Project(aValue);
