		...
		this.formPanel = new Ext.FormPanel({
			...
			items : [{
				...
				items : [{
										...
										handler : function() {
											 new UserDialog({
										 		...
										 		callback : function(ids, names) {
										  			Ext.getCmp('signupUser').setValue(names);
										 		}
										 	}).show();
										}
									}]
						...
						{
						fieldLabel : '图书类别',
						hiddenName : 'contract.serviceDep',
							...
							items : [{
										...
										handler : function() {
										 new UserDialog({
										 		...
										 		isForFlow : false,
										 		callback : function(ids, names) {
										  			Ext.getCmp('serviceMan').setValue(names);
										 		}
										 	}).show();
										}
									}]
					...
					items : [{
								...
								handler : function() {
									new ProjectDialog({
										scope : this,
										single : true,
										callback : function(projectId, projectName, projectNo) {
