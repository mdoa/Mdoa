		...
		.extend(
				Ext.Panel,
				{
					...
					initUIComponents : function() {
									...
									items : [
											...
											},
											{
												...
												items : {
													...
													allowBlank : false,
													width : 100,
													name : 'NewBorrowRecordForm.borrowRecord.returnStatusName',
													readOnly : true,
													xtype : 'textfield'
												}
											},
						...
						this.fileListGrid.store.on('beforeload',
								this.fileListGridBeforeload, this);
						this.load();
					 ...
					 * 
					 */
					fileListGridBeforeload : function(store) {
						if (this.recordId) {
							store.baseParams = {
					...
					save : function() {
						if (this.formPanel.getForm().isValid()) {
							...
							this.formPanel.getForm().findField(
									'borrowRecord.returnStatus').setValue(0);
										...
										.submit(
												{
													...
													success : function(form,
														...
														centerPanel
																.remove(this);
														var MyBorrowRecordView= Ext
																.getCmp('MyBorrowRecordView');
														if(MyBorrowRecordView)
															MyBorrowRecordView.gridPanel.getStore().reload();
