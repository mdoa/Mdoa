 ...
 * <P>product:joffice</P>
 * <P></P> 
 * @see com.htsoft.oa.service.flow.impl.FlowFormServiceImpl
 * <P></P>
 * @author 
 * @version V1
					...
					**/
					...
					if(titleField!=null){
						try{
							...
							//取得流程定义id
							String nameID = flowRunInfo.getDefId();
							//通过id取流程定义对象信息
							proDefinition = proDefinitionService.get(new Long(nameID));
							flowRunInfo.setFlowSubject(proDefinition.getName()+"_"+flowSubject);
						}catch(Exception ex){
