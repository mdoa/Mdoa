...
/**
 * Diary Base Java Bean, base class for the.oa.model, mapped directly to
 * database table
 * 
...
public class Diary extends com.htsoft.core.model.BaseModel {
	...
	public String getUserName() {
		return this.getAppUser() == null ? null : this.getAppUser().getFullname();
	}
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.diaryId, rhs.diaryId).append(
				...
				.append(this.diaryType, rhs.diaryType).append(this.userName, rhs.userName).isEquals();
	}
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.diaryId)
				.append(this.dayTime).append(this.content).append(
						this.diaryType).append(this.userName).toHashCode();
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("diaryId", this.diaryId)
				...
				.append("content", this.content).append("diaryType",
						this.diaryType).append("userName",this.userName).toString();
	}
