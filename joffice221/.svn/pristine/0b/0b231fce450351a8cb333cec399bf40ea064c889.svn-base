...
/**
 * FormDef Base Java Bean, base class for the.oa.model, mapped directly to
 * database table
 * 
 ...
 */
public class FormDef extends com.htsoft.core.model.BaseModel {
	/**
	 * 
	 */
	private static final long serialVersionUID = 5916862883711140593L;
	/**
	 * 缺省流程表单定义ID
	 */
	...
	public java.util.Set<FormTable> getFormTables() {
		return formTables;
	}

	public void setFormTables(java.util.Set<FormTable> in_formTables) {
	 ...
	 * 表单ID * @return Long
	 * 
	 * @hibernate.id column="formDefId" type="java.lang.Long"
	 ...
	 * 表单标题 * @return String
	 * 
	 * @hibernate.property column="formTitle" type="java.lang.String"
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="formDesp" type="java.lang.String"
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="defHtml" type="java.lang.String"
	 *                     length="65535" not-null="false" unique="false"
	 */
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973)
				.append(this.formDefId).append(this.formTitle)
				.append(this.formDesp).append(this.defHtml).append(this.status)
				.toHashCode();
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("formDefId", this.formDefId)
				...
				.append("defHtml", this.defHtml).append("status", this.status)
				.toString();
	}
