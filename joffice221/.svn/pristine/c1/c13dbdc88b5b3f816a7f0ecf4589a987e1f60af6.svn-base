...
/**
 * HolidayRecord Base Java Bean, base class for the.oa.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * 
 */
public class HolidayRecord extends com.htsoft.core.model.BaseModel {
