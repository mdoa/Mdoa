...
/**
 * SmsHistory Base Java Bean, base class for the.oa.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * TODO: add class/table comments
 */
public class SmsHistory extends com.htsoft.core.model.BaseModel {
	...
	/**
	 * Default Empty Constructor for class SmsHistory
	 */
	public SmsHistory () {
		super();
	}
	...
	/**
	 * Default Key Fields Constructor for class SmsHistory
	 */
	public SmsHistory (
		 Long in_smsId
        ) {
