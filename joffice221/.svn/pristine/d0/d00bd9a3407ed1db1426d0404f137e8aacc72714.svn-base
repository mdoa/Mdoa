...
/**
 * RollFile Base Java Bean, base class for the.oa.model, mapped directly to
 * database table
 * 
 ...
 */
public class RollFile extends com.htsoft.core.model.BaseModel {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2488197910996900839L;
	@Expose
	...
	@Expose
	@JsonBackReference
	protected java.util.Set<com.htsoft.oa.model.arch.BorrowFileList> borrowFileList = new java.util.HashSet<com.htsoft.oa.model.arch.BorrowFileList>();
	@Expose
	@JsonBackReference
	protected java.util.Set<com.htsoft.oa.model.arch.RollFile> rollFileLists = new java.util.HashSet<com.htsoft.oa.model.arch.RollFile>();
	@Expose
	protected String tidyName;
	@Expose
	protected java.util.Date tidyTime;

	public java.util.Set<BorrowFileList> getBorrowFileList() {
		return borrowFileList;
	}

	public void setBorrowFileList(
			java.util.Set<com.htsoft.oa.model.arch.BorrowFileList> borrowFileList) {
	...
	public void setGlobalType(
			com.htsoft.oa.model.system.GlobalType in_globalType) {
		this.globalType = in_globalType;
	}

	public java.util.Set<com.htsoft.oa.model.arch.RollFile> getRollFileLists() {
		return rollFileLists;
	}

	public void setRollFileLists(
			java.util.Set<com.htsoft.oa.model.arch.RollFile> in_rollFileLists) {
	 ...
	 * * @return Long
	 * 
	 * @hibernate.id column="rollFileId" type="java.lang.Long"
	...
	public void setRollId(Long aValue) {
		if (aValue == null) {
			...
			archRoll.setVersion(new Integer(0));// set a version to cheat
												// hibernate only
		} else {
	 ...
	 * 文件编号 * @return String
	 * 
	 * @hibernate.property column="fileNo" type="java.lang.String" length="64"
	 ...
	 * 责任者 * @return String
	 * 
	 * @hibernate.property column="dutyPerson" type="java.lang.String"
	 ...
	 * 目录号 * @return String
	 * 
	 * @hibernate.property column="catNo" type="java.lang.String" length="64"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * 案卷号 * @return String
	 * 
	 * @hibernate.property column="rollNo" type="java.lang.String" length="64"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * 顺序号 * @return Integer
	 * 
	 * @hibernate.property column="seqNo" type="java.lang.Integer" length="10"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * 页号 * @return Integer
	 * 
	 * @hibernate.property column="pageNo" type="java.lang.Integer" length="10"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * 页数 * @return Integer
	 * 
	 * @hibernate.property column="pageNums" type="java.lang.Integer"
	 ...
	 * 密级 * @return Short
	 * 
	 * @hibernate.property column="secretLevel" type="java.lang.Short"
	 ...
	 * 保管期限 * @return String
	 * 
	 * @hibernate.property column="timeLimit" type="java.lang.String"
	 ...
	 * 附注 * @return String
	 * 
	 * @hibernate.property column="notes" type="java.lang.String" length="4000"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * 
	 * @hibernate.property column="fileTime" type="java.util.Date" length="19"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * 归档状态 * @return Short
	 * 
	 * @hibernate.property column="archStatus" type="java.lang.Short" length="5"
	 *                     not-null="false" unique="false"
	 */
