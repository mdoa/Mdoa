...
/**
 * News Base Java Bean, base class for the.oa.model, mapped directly to database
 * table
 * 
...
public class News extends com.htsoft.core.model.BaseModel {
	 ...
	 * ID * @return Long
	 * 
	 * @hibernate.id column="newsId" type="java.lang.Long"
	...
	public Long getSectionId() {
		return this.getSection() == null ? null : this.getSection()
				.getSectionId();
	}
	...
	public void setSectionId(Long aValue) {
		if (aValue == null) {
			...
			section.setVersion(new Integer(0));// set a version to cheat
												// hibernate only
		} else {
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="subjectIcon" type="java.lang.String"
	 ...
	 * 作者 * @return String
	 * 
	 * @hibernate.property column="author" type="java.lang.String" length="32"
	 *                     not-null="true" unique="false"
	 */
	 ...
	 * 
	 * @hibernate.property column="expTime" type="java.util.Date" length="19"
	 ...
	 * * @return Integer
	 * 
	 * @hibernate.property column="replyCounts" type="java.lang.Integer"
	 ...
	 * 浏览数 * @return Integer
	 * 
	 * @hibernate.property column="viewCounts" type="java.lang.Integer"
	 *                     length="10" not-null="false" unique="false"
	 */
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="issuer" type="java.lang.String" length="32"
	 *                     not-null="true" unique="false"
	 */
	 ...
	 * 
	 * @hibernate.property column="isDeskImage" type="java.lang.Short"
	 ...
	 * * @return Short
	 * 
	 * @hibernate.property column="isNotice" type="java.lang.Short" length="5"
	 *                     not-null="false" unique="false"
	 */
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.newsId, rhs.newsId)
				...
				.append(this.isNotice, rhs.isNotice).append(this.sn, rhs.sn)
				.append(this.orgIds,rhs.orgIds).append(this.orgNames,this.orgNames)
				.isEquals();
	}
	 ...
	 */
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.newsId)
				.append(this.subjectIcon).append(this.subject)
				.append(this.author).append(this.createtime)
				.append(this.expTime).append(this.replyCounts)
				.append(this.viewCounts).append(this.issuer)
				.append(this.content).append(this.updateTime)
				.append(this.status).append(this.isDeskImage)
				.append(this.isNotice).append(this.sn)
				.append(this.orgIds).append(this.orgNames).toHashCode();
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("newsId", this.newsId)
				.append("subjectIcon", this.subjectIcon)
				.append("subject", this.subject).append("author", this.author)
				.append("createtime", this.createtime)
				.append("expTime", this.expTime)
				.append("replyCounts", this.replyCounts)
				.append("viewCounts", this.viewCounts)
				.append("issuer", this.issuer).append("content", this.content)
				.append("updateTime", this.updateTime)
				.append("status", this.status)
				.append("isDeskImage", this.isDeskImage)
				.append("isNotice", this.isNotice).append("sn", this.sn)
				.append("orgIds",this.orgIds).append("orgNames",this.orgNames)
				.toString();
	}
