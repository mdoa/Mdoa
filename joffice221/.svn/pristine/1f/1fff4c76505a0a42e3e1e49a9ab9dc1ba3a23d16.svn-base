...
/**
 * OfficeGoods Base Java Bean, base class for the.oa.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * ������������
 */
public class OfficeGoods extends com.htsoft.core.model.BaseModel {
	...
	protected com.htsoft.oa.model.admin.OfficeGoodsType officeGoodsType;
    @ JsonBackReference
	...
	public com.htsoft.oa.model.admin.OfficeGoodsType getOfficeGoodsType () {
		return officeGoodsType;
	}	
	
	public void setOfficeGoodsType (com.htsoft.oa.model.admin.OfficeGoodsType in_officeGoodsType) {
...
//	}
	...
	public void setTypeId(Long aValue) {
	    if (aValue==null) {
	        ...
	        officeGoodsType = new com.htsoft.oa.model.admin.OfficeGoodsType(aValue);
