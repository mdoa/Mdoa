...
(function()
{
	...
	function dtableDialog( editor, command )
	{
	...
	CKEDITOR.dialog.add( 'dtable', function( editor )
		{
			return dtableDialog( editor, 'dtable' );
		} );
	CKEDITOR.dialog.add( 'dtableProperties', function( editor )
		{
			return dtableDialog( editor, 'dtableProperties' );
		} );
})();
