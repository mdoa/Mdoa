...
<%@page import="com.htsoft.oa.service.admin.RegulationService"%>
<%@page import="com.htsoft.oa.model.admin.Regulation"%>
<%
	String regId = request.getParameter("regId");
	RegulationService regulationService = (RegulationService)AppUtil.getBean("regulationService");
	Regulation regulation=new Regulation();
	if(StringUtils.isNotEmpty(regId)){System.out.print(regId);
				  	...
				  	<c:forEach var="regfile" items="${regulation.regAttachs}">
				  	 	<tr>
				  	 		<td colspan="3" style="padding-left:10px;border: 1px #c7e3fa solid;">
				      			...
				      			<a href="<%=request.getContextPath()%>/file-download?fileId=${regfile.fileId}"  target="_blank">${regfile.fileName}</a>&nbsp;&nbsp;&nbsp;&nbsp;
				  			</td>
				  		</tr>
				  	</c:forEach>
				  </tr>
