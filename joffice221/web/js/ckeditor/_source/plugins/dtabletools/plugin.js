...
(function()
{
	...
	CKEDITOR.plugins.dtabletools =
	{
		init : function( editor )
		{
			var lang = editor.lang.table;

			editor.addCommand( 'dcellProperties', new CKEDITOR.dialogCommand( 'dcellProperties' ) );
			CKEDITOR.dialog.add( 'dcellProperties', this.path + 'dialogs/tableCell.js' );

			editor.addCommand( 'dtableDelete',
				{
			...
			editor.addCommand( 'drowInsertBefore',
				{
					exec : function( editor )
					{
						var selection = editor.getSelection();
			...
			editor.addCommand( 'drowInsertAfter',
				{
					exec : function( editor )
					{
						var selection = editor.getSelection();
			...
			editor.addCommand( 'dcolumnDelete',
				{
					exec : function( editor )
					{
						var selection = editor.getSelection();
			...
			editor.addCommand( 'dcolumnInsertBefore',
				{
					exec : function( editor )
					{
						var selection = editor.getSelection();
			...
			editor.addCommand( 'dcolumnInsertAfter',
				{
					exec : function( editor )
					{
						var selection = editor.getSelection();
			...
			editor.addCommand( 'dcellMergeRight',
				{
					exec : function( editor )
					{
			...
			editor.addCommand( 'dcellMergeDown',
				{
					exec : function( editor )
					{
			...
			editor.addCommand( 'dcellVerticalSplit',
				{
					exec : function( editor )
					{
			...
			editor.addCommand( 'dcellHorizontalSplit',
				{
					exec : function( editor )
					{
			...
			editor.addCommand( 'dcellInsertBefore',
				{
					exec : function( editor )
					{
						var selection = editor.getSelection();
			...
			editor.addCommand( 'dcellInsertAfter',
				{
					exec : function( editor )
					{
						var selection = editor.getSelection();
				...
				editor.addMenuItems(
					{
						dtablecell :
						{
							...
							getItems : function()
							{
								...
								return {
									dtablecell_insertBefore : CKEDITOR.TRISTATE_OFF,
									dtablecell_insertAfter : CKEDITOR.TRISTATE_OFF,
									dtablecell_delete : CKEDITOR.TRISTATE_OFF,
									dtablecell_merge : mergeCells( selection, null, true ) ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED,
									dtablecell_merge_right : mergeCells( selection, 'right', true ) ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED,
									dtablecell_merge_down : mergeCells( selection, 'down', true ) ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED,
									dtablecell_split_vertical : verticalSplitCell( selection, true ) ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED,
									dtablecell_split_horizontal : horizontalSplitCell( selection, true ) ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED,
									dtablecell_properties : cells.length > 0 ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED
								};
							}
						},

						dtablecell_insertBefore :
						{
							label : lang.cell.insertBefore,
							group : 'dtablecell',
							command : 'dcellInsertBefore',
							order : 5
						},

						dtablecell_insertAfter :
						{
							label : lang.cell.insertAfter,
							group : 'dtablecell',
							command : 'dcellInsertAfter',
							order : 10
						},
						...
						dtablecell_merge_right :
						{
							label : lang.cell.mergeRight,
							group : 'dtablecell',
							command : 'dcellMergeRight',
							order : 17
						},

						dtablecell_merge_down :
						{
							label : lang.cell.mergeDown,
							group : 'dtablecell',
							command : 'dcellMergeDown',
							order : 18
						},

						dtablecell_split_horizontal :
						{
							label : lang.cell.splitHorizontal,
							group : 'dtablecell',
							command : 'dcellHorizontalSplit',
							order : 19
						},

						dtablecell_split_vertical :
						{
							label : lang.cell.splitVertical,
							group : 'dtablecell',
							command : 'dcellVerticalSplit',
							order : 20
						},

						dtablecell_properties :
						{
							label : lang.cell.title,
							group : 'dtablecellproperties',
							command : 'dcellProperties',
							order : 21
						},
						...
						dtablerow :
						{
							...
							{
								return {
									dtablerow_insertBefore : CKEDITOR.TRISTATE_OFF,
									dtablerow_insertAfter : CKEDITOR.TRISTATE_OFF,
									dtablerow_delete : CKEDITOR.TRISTATE_OFF
								};
							}
						},

						dtablerow_insertBefore :
						{
							label : lang.row.insertBefore,
							group : 'dtablerow',
							command : 'drowInsertBefore',
							order : 5
						},

						dtablerow_insertAfter :
						{
							label : lang.row.insertAfter,
							group : 'dtablerow',
							command : 'drowInsertAfter',
							order : 10
						},
						...
						dtablecolumn :
						{
							...
							{
								return {
									dtablecolumn_insertBefore : CKEDITOR.TRISTATE_OFF,
									dtablecolumn_insertAfter : CKEDITOR.TRISTATE_OFF,
									dtablecolumn_delete : CKEDITOR.TRISTATE_OFF
								};
							}
						},

						dtablecolumn_insertBefore :
						{
							label : lang.column.insertBefore,
							group : 'dtablecolumn',
							command : 'dcolumnInsertBefore',
							order : 5
						},

						dtablecolumn_insertAfter :
						{
							label : lang.column.insertAfter,
							group : 'dtablecolumn',
							command : 'dcolumnInsertAfter',
							order : 10
						},
				...
				editor.contextMenu.addListener( function( element, selection )
					{
						...
						while ( element )
						{
							...
							{
								return {
									dtablecell : CKEDITOR.TRISTATE_OFF,
									dtablerow : CKEDITOR.TRISTATE_OFF,
									dtablecolumn : CKEDITOR.TRISTATE_OFF
								};
							}
	...
	CKEDITOR.plugins.add( 'dtabletools', CKEDITOR.plugins.dtabletools );
})();
