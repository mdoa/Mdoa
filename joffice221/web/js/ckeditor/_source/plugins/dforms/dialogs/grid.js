			...
			contents : [
				{
					...
					[  {
							id : 'txtname',
							type : 'text',
							label : editor.lang.grid.tablename,
							validate : CKEDITOR.dialog.validate.colNameValidate(
									editor.lang.grid.tablename+ editor.lang.dcommon.colNameValidate),
							'default' : '',
							accessKey : 'T',
							width:'100%',
							setup : function( selectedTable )
							{
								this.setValue( selectedTable.getAttribute( 'txtname' ) );
							},
							commit : function( data, selectedTable )
							{
								selectedTable.setAttribute( 'txtname', this.getValue() );
							}
						}, {
							id : 'isgrid',
							type : 'checkbox',
							label : editor.lang.grid.detailgrid,
							'default' : 'checked',
							accessKey : 'P',
							value : "checked",
