...
CKEDITOR.plugins.add( 'dforms',
{
	...
	init : function( editor )
	{
		...
		addButtonCommand( 'DSelect',		'dselect',		dialogPath + 'select.js' );
			...
			editor.addMenuItems(
				{
					...
					userselector : 
					{
						label : lang.userselector.title,
						command : 'userselector',
						group : 'userselector'
					},
					datefield : 
					{
						label : lang.datefield.title,
						command : 'datefield',
						group : 'datefield'
					},
					depselector : 
					{
						label : lang.depselector.title,
						command : 'depselector',
						group : 'depselector'
					},
					posselector : 
					{
						label : lang.posselector.title,
						command : 'posselector',
						group : 'posselector'
					},
					dselect : 
					{
						label : lang.dselect.title,
						command : 'dselect',
						group : 'dselect'
					},
					dhiddenfield : 
					{
						label : lang.dhiddenfield.title,
					...
					ckeditor : 
					{
						label : lang.ckeditor.title,
						command : 'ckeditor',
						group : 'ckeditor'
					},
					officeeditor : 
					{
						label : lang.officeeditor.title,
						command : 'officeeditor',
						group : 'officeeditor'
					},
					fileattach:
					{
						label : lang.fileattach.title,
						command : 'fileattach',
						group : 'fileattach'
					},
					grid :
					{
						label : lang.grid.title,
						command : 'gridProperties',
						group : 'grid'
					},
					griddelete:{
						label : lang.griddelete.title,
						command : 'dtableDelete',
						group : 'dtable'
					},
					commoneditor:{
						label : lang.commoneditor.title,
						command : 'commoneditor',
						group : 'commoneditor'
					},
					diccombo:{
						label:lang.diccombo.title,
						command:'diccombo',
						group : 'diccombo'
					}
				});
				...
				else if ( element.is( 'input' ) )
				{
					switch ( element.getAttribute( 'type' ) )
					{
						...
						case 'reset' :
							...
							break;
						case 'checkbox' :
							evt.data.dialog = 'dcheckbox';
							break;
						case 'radio' :
							evt.data.dialog = 'dradio';
							break;
						case 'image' :
