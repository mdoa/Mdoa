	...
	initUIComponents : function() {
		...
		this.gridPanel = new HT.GridPanel({
			...
			fields : [ {
				name : 'sealId',
				type : 'int'
			}, 'fileId', 'sealName', 'sealPath', 'belongId', 'belongName',
					'fileAttach' ],
			columns : [ {
				header : 'sealId',
				dataIndex : 'sealId',
