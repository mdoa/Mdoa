...
(function() {
	...
	window.UEDITOR_CONFIG = {
		...
		,
		scrawlPath : reviseURL // 图片修正地址，同imagePath
		...
		// //提交到后台远程图片uri合集，若此处修改，需要在后台对应文件修改对应参数
		...
		,
		wordImagePath : reviseURL // word转存地址
...
//				'|','touppercase', 'tolowercase', 
				...
				'|', 'insertimage', 'emotion', 'insertframe', 
//				'scrawl', 'insertvideo','attachment', 'map', 'gmap', ,'webapp','highlightcode',
//				'date', 'time', 'snapscreen','wordimage', 
				 'horizontal','pagebreak', 'template', 'background', 'spechars',
				'|', 'inserttable', 'deletetable',
				'insertparagraphbeforetable', 'insertrow', 'deleterow',
				'insertcol', 'deletecol', 'mergecells', 'mergeright',
				'mergedown', 'splittocells', 'splittorows', 'splittocols', '|',
				//'print', 'preview', 
				'searchreplace', 'help', '|', 'hidedomain',
		...
		,
		iframeCssUrl : __ctxPath + "/css/form.css" // 给编辑器内部引入一个css文件
