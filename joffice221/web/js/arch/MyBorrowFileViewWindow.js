 ...
 * @author
 * @createtime
 * @class MyBorrowFileViewWindow
 * @extends Ext.Window
 * @description RollFile表单
 * @company 宏天软件
 */
MyBorrowFileViewWindow = Ext.extend(Ext.Window, {
	// 构造函数
	constructor : function(_cfg) {
		Ext.applyIf(this, _cfg);
		// 必须先初始化组件
		this.initUIComponents();
		MyBorrowFileViewWindow.superclass.constructor.call(this, {
					layout : 'form',
									...
									if (xtype == 'textfield'
										...
										if (name) {
											...
											if (val != null && val != undefined) {
												if (comp.getId() == 'MyBorrowFileWiewWindow.rollFile.archStatus') {// 特殊情况
													if (val == 1) {
														val = '已归档';
													} else {
														val = '未归档';
