...
Ext.extend(Ext.ux.form.FCKeditor, Ext.form.TextArea, {
			...
			onRender : function(ct, position) {
				...
				//setTimeoutEx(loadFCKeditor, 100, this); // setTimeoutEx			
				loadFCKeditor(this);
...
function loadFCKeditor(ckExtObj) {
	var element=ckExtObj.config.id;
	var config=ckExtObj.fckconfig;
	//加载fckEditor js
