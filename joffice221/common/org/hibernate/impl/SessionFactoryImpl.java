...
public final class SessionFactoryImpl implements SessionFactory, SessionFactoryImplementor {
	...
	public SessionFactoryImpl(
		...
		collectionRolesByEntityParticipant = tmpEntityToCollectionRoleMap;
	...
	public void addNewConfig(Configuration cfg){
		...
		while ( classes.hasNext() ) {
			...
			System.out.println("cacheRegionName:"+cacheRegionName);
