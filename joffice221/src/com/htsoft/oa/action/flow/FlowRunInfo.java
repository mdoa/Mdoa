...
public class FlowRunInfo {
	 ...
	 * 设置流程业务变量
	 */
	private Map<String,String> flowVars=new HashMap<String,String>();
	...
	public FlowRunInfo(HttpServletRequest request) {
		...
		String pSubject=request.getParameter("flowSubject");
		if(StringUtils.isNotEmpty(pSubject)){
			flowSubject=pSubject;
		}
