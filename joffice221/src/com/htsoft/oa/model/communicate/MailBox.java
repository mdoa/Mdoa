...
/**
 * MailBox Base Java Bean, base class for the.oa.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * ���������
 */
public class MailBox extends com.htsoft.core.model.BaseModel {
	...
	protected com.htsoft.oa.model.communicate.Mail mail;
	@Expose
	@JsonManagedReference
	protected com.htsoft.oa.model.system.AppUser appUser;
	@Expose
	@JsonManagedReference
	protected com.htsoft.oa.model.communicate.MailFolder mailFolder;
	...
	public com.htsoft.oa.model.communicate.Mail getMail(){
		return mail;
	}	
	
	public void setMail (com.htsoft.oa.model.communicate.Mail in_mail) {
		this.mail = in_mail;
	}
	...
	public com.htsoft.oa.model.communicate.MailFolder getMailFolder () {
		return mailFolder;
	}	
	
	public void setMailFolder (com.htsoft.oa.model.communicate.MailFolder in_mailFolder) {
	...
	public void setMailId(Long aValue) {
	    if (aValue==null) {
	        ...
	        mail = new com.htsoft.oa.model.communicate.Mail(aValue);
	...
	public void setFolderId(Long aValue) {
	    if (aValue==null) {
	        ...
	        mailFolder = new com.htsoft.oa.model.communicate.MailFolder(aValue);
