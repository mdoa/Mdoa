...
/**
 * Mail Base Java Bean, base class for the.oa.model, mapped directly to database
 * table
 * 
 ...
 * 内部邮箱
 */
public class Mail extends com.htsoft.core.model.BaseModel {
	/***/
	...
	/** 短信息中的系统信息类型 */
	public static final Short SYSTEM_MESSAGE = 4;
	/** 重要程度一般 */
	public static final Short COMMON = 1;
	/** 重要 */
	public static final Short IMPORTANT = 2;
	/** 非常重要 */
	public static final Short VERY_IMPORTANT = 3;

	/** 邮件为草稿 */
	public static final Short IS_DRAFT = 0;
	/** 邮件为正式邮件 */
	public static final Short IS_MAIL = 1;
	...
	/**
	 * 1=一般 2=重要 3=非常重要 * @return Short
	 * 
	 * @hibernate.property column="importantFlag" type="java.lang.Short"
	 ...
	 * 
	 * @hibernate.property column="sendTime" type="java.util.Date" length="19"
	 ...
	 * 
	 * @hibernate.property column="copyToNames" type="java.lang.String"
	 ...
	 * 
	 * @hibernate.property column="copyToIDs" type="java.lang.String"
	 *                     length="1000" not-null="false" unique="false"
	 */
	 ...
	 * 
	 * @hibernate.property column="recipientNames" type="java.lang.String"
	 *                     length="1000" not-null="true" unique="false"
	 */
	 ...
	 * 
	 * @hibernate.property column="recipientIDs" type="java.lang.String"
	 *                     length="1000" not-null="true" unique="false"
	 */
	 ...
	 * 
	 * @hibernate.property column="mailStatus" type="java.lang.Short" length="5"
	 *                     not-null="true" unique="false"
	 */
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.mailId)
				.append(this.sender).append(this.importantFlag)
				.append(this.sendTime).append(this.content)
				.append(this.subject).append(this.copyToNames)
				.append(this.copyToIDs).append(this.recipientNames)
				.append(this.recipientIDs).append(this.mailStatus)
				.append(this.fileIds).append(this.filenames).toHashCode();
	}
