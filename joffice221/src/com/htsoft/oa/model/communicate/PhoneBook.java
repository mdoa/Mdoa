...
/**
 * PhoneBook Base Java Bean, base class for the.oa.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * ���������
 */
public class PhoneBook extends com.htsoft.core.model.BaseModel {
	...
	@Expose
	@JsonManagedReference
	protected com.htsoft.oa.model.communicate.PhoneGroup phoneGroup;
	...
	public com.htsoft.oa.model.communicate.PhoneGroup getPhoneGroup () {
		return phoneGroup;
	}	
	
	public void setPhoneGroup (com.htsoft.oa.model.communicate.PhoneGroup in_phoneGroup) {
	...
	public void setGroupId(Long aValue) {
	    if (aValue==null) {
	        ...
	        phoneGroup = new com.htsoft.oa.model.communicate.PhoneGroup(aValue);
