...
/**
 * DocPrivilege Base Java Bean, base class for the.oa.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * ������������������������������������������������������������
 */
public class DocPrivilege extends com.htsoft.core.model.BaseModel {
	...
	protected com.htsoft.oa.model.document.Document document;
	protected com.htsoft.oa.model.document.DocFolder docFolder;
	...
	public com.htsoft.oa.model.document.Document getDocument () {
		return document;
	}	
	
	public void setDocument (com.htsoft.oa.model.document.Document in_document) {
		this.document = in_document;
	}
	
	public com.htsoft.oa.model.document.DocFolder getDocFolder () {
		return docFolder;
	}	
	
	public void setDocFolder (com.htsoft.oa.model.document.DocFolder in_docFolder) {
	...
	public void setFolderId(Long aValue) {
	    if (aValue==null) {
	        ...
	        docFolder = new com.htsoft.oa.model.document.DocFolder(aValue);
	...
	public void setDocId(Long aValue) {
	    if (aValue==null) {
	        ...
	        document = new com.htsoft.oa.model.document.Document(aValue);
