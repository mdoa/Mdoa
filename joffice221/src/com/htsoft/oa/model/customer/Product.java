...
/**
 * Product Base Java Bean, base class for the.oa.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * ��������������������
 */
public class Product extends com.htsoft.core.model.BaseModel {
	...
	protected com.htsoft.oa.model.customer.Provider provider;
	...
	public com.htsoft.oa.model.customer.Provider getProvider () {
		return provider;
	}	
	
	public void setProvider (com.htsoft.oa.model.customer.Provider in_provider) {
	...
	public void setProviderId(Long aValue) {
	    if (aValue==null) {
	        ...
	        provider = new com.htsoft.oa.model.customer.Provider(aValue);
