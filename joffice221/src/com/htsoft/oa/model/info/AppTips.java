...
/**
 * AppTips Base Java Bean, base class for the.oa.model, mapped directly to
 * database table
 * 
 ...
 */
public class AppTips extends com.htsoft.core.model.BaseModel {
	 ...
	 * * @return Long
	 * 
	 * @hibernate.id column="tipsId" type="java.lang.Long"
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="tipsName" type="java.lang.String"
	 ...
	 * * @return Integer
	 * 
	 * @hibernate.property column="disheight" type="java.lang.Integer"
	 ...
	 * * @return Integer
	 * 
	 * @hibernate.property column="diswidth" type="java.lang.Integer"
	 *                     length="10" not-null="false" unique="false"
	 */
	 ...
	 * * @return Integer
	 * 
	 * @hibernate.property column="disleft" type="java.lang.Integer" length="10"
	 ...
	 * * @return Integer
	 * 
	 * @hibernate.property column="distop" type="java.lang.Integer" length="10"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * * @return Integer
	 * 
	 * @hibernate.property column="dislevel" type="java.lang.Integer"
	 *                     length="10" not-null="false" unique="false"
	 */
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.tipsId, rhs.tipsId)
	 ...
	 */
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.tipsId)
				.append(this.tipsName).append(this.content)
				.append(this.disheight).append(this.diswidth)
				.append(this.disleft).append(this.distop).append(this.dislevel)
	...
	public String toString() {
		return new ToStringBuilder(this).append("tipsId", this.tipsId)
				.append("tipsName", this.tipsName)
				.append("content", this.content)
				.append("disheight", this.disheight)
				.append("diswidth", this.diswidth)
				.append("disleft", this.disleft).append("distop", this.distop)
