...
/**
 * ArchivesDep Base Java Bean, base class for the.oa.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * TODO: add class/table comments
 */
public class ArchivesDep extends com.htsoft.core.model.BaseModel {
	/**
	 * 主送部门 
	 */
	...
	protected com.htsoft.oa.model.archive.Archives archives;
	@JsonManagedReference
...
//	public com.htsoft.oa.model.archive.ArchRecType getArchRecType () {
//		return archRecType;
//	}	
//	
//	public void setArchRecType (com.htsoft.oa.model.archive.ArchRecType in_archRecType) {
//		this.archRecType = in_archRecType;
//	}
	
	public com.htsoft.oa.model.archive.Archives getArchives () {
		return archives;
	}	
	
	public void setArchives (com.htsoft.oa.model.archive.Archives in_archives) {
	...
	public void setArchivesId(Long aValue) {
	    if (aValue==null) {
	        ...
	        archives = new com.htsoft.oa.model.archive.Archives(aValue);
...
//	        archRecType = new com.htsoft.oa.model.archive.ArchRecType(aValue);
