...
/**
 * DutyRegister Base Java Bean, base class for the.oa.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * TODO: add class/table comments
 */
public class DutyRegister extends com.htsoft.core.model.BaseModel {
	/*
	 * 签到标识
	 */
