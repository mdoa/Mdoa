...
/**
 * WorkPlan Base Java Bean, base class for the.oa.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * ������������
 */
public class WorkPlan extends com.htsoft.core.model.BaseModel {
...
//	public com.htsoft.oa.model.task.PlanType getPlanType () {
//		return planType;
//	}	
//	
//	public void setPlanType (com.htsoft.oa.model.task.PlanType in_planType) {
...
//	        planType = new com.htsoft.oa.model.task.PlanType(aValue);
...
//	}	
	...
	public void setProTypeId(Long typeId) {
		if(typeId==null){
			...
			globalType=new com.htsoft.oa.model.system.GlobalType(typeId);
