...
/**
 * Resume Base Java Bean, base class for the.oa.model, mapped directly to
 * database table
 * 
 ...
 * ������������
 */
public class Resume extends com.htsoft.core.model.BaseModel {
	...
	public java.util.Set<FileAttach> getResumeFiles() {
		return resumeFiles;
	}

	public void setResumeFiles(java.util.Set<FileAttach> resumeFiles) {
	 ...
	 * * @return Long
	 * 
	 * @hibernate.id column="resumeId" type="java.lang.Long"
	 ...
	 * * @return Integer
	 * 
	 * @hibernate.property column="age" type="java.lang.Integer" length="10"
	 ...
	 * 
	 * @hibernate.property column="birthday" type="java.util.Date" length="19"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="address" type="java.lang.String" length="128"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="sex" type="java.lang.String" length="32"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="position" type="java.lang.String" length="64"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="phone" type="java.lang.String" length="64"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="mobile" type="java.lang.String" length="64"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="hobby" type="java.lang.String" length="256"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="religion" type="java.lang.String"
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="party" type="java.lang.String" length="128"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="nationality" type="java.lang.String"
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="race" type="java.lang.String" length="32"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="birthPlace" type="java.lang.String"
	 *                     length="128" not-null="false" unique="false"
	 */
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="eduCollege" type="java.lang.String"
	 *                     length="128" not-null="false" unique="false"
	 */
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="eduDegree" type="java.lang.String"
	 *                     length="128" not-null="false" unique="false"
	 */
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="eduMajor" type="java.lang.String"
	 *                     length="128" not-null="false" unique="false"
	 */
	 ...
	 * * @return java.util.Date
	 * 
	 * @hibernate.property column="startWorkDate" type="java.util.Date"
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="idNo" type="java.lang.String" length="64"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * 
	 * @return String
	 * @hibernate.property column="status" type="java.lang.String" length="64"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="registor" type="java.lang.String" length="64"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * * @return java.util.Date
	 * 
	 * @hibernate.property column="regTime" type="java.util.Date" length="19"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="workCase" type="java.lang.String"
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="trainCase" type="java.lang.String"
	 *                     length="65535" not-null="false" unique="false"
	 */
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="projectCase" type="java.lang.String"
	 *                     length="65535" not-null="false" unique="false"
	 */
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.resumeId, rhs.resumeId)
				.append(this.fullname, rhs.fullname).append(this.age, rhs.age)
				.append(this.birthday, rhs.birthday)
				.append(this.address, rhs.address).append(this.zip, rhs.zip)
				.append(this.sex, rhs.sex).append(this.position, rhs.position)
				.append(this.phone, rhs.phone).append(this.mobile, rhs.mobile)
				.append(this.email, rhs.email).append(this.hobby, rhs.hobby)
				...
				.append(this.idNo, rhs.idNo).append(this.photo, rhs.photo)
				.append(this.status, rhs.status).append(this.memo, rhs.memo)
	 ...
	 */
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.resumeId)
				.append(this.fullname).append(this.age).append(this.birthday)
				.append(this.address).append(this.zip).append(this.sex)
				.append(this.position).append(this.phone).append(this.mobile)
				.append(this.email).append(this.hobby).append(this.religion)
				.append(this.party).append(this.nationality).append(this.race)
				.append(this.birthPlace).append(this.eduCollege)
				.append(this.eduDegree).append(this.eduMajor)
				.append(this.startWorkDate).append(this.idNo)
				.append(this.photo).append(this.status).append(this.memo)
				.append(this.registor).append(this.regTime)
				.append(this.workCase).append(this.trainCase)
				.append(this.projectCase).toHashCode();
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("resumeId", this.resumeId)
				.append("fullname", this.fullname).append("age", this.age)
				.append("birthday", this.birthday)
				.append("address", this.address).append("zip", this.zip)
				.append("sex", this.sex).append("position", this.position)
				.append("phone", this.phone).append("mobile", this.mobile)
				.append("email", this.email).append("hobby", this.hobby)
				.append("religion", this.religion).append("party", this.party)
				...
				.append("idNo", this.idNo).append("photo", this.photo)
				.append("status", this.status).append("memo", this.memo)
