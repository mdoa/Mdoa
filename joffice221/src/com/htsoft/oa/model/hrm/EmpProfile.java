...
/**
 * EmpProfile Base Java Bean, base class for the.oa.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * ������������
 */
public class EmpProfile extends com.htsoft.core.model.BaseModel {
	...
	protected String profileNo;//档案编号
	protected String fullname;//员工姓名
	protected String address;//家庭地址
	protected java.util.Date birthday;//出生地
	protected String homeZip;//家庭邮编
	protected String sex;//性别
	protected String marriage;//婚姻状况
	protected String designation;//职称
	protected String position;//职位
	protected String phone;//电话号
	protected String mobile;//手机号
	protected String openBank;//开户银行
	protected String bankNo;//银行账号
	protected String qq;
	...
	protected com.htsoft.oa.model.hrm.StandSalary standSalary;
	@JsonManagedReference
...
//	}
	...
	public com.htsoft.oa.model.hrm.StandSalary getStandSalary () {
		return standSalary;
	}	
	
	public void setStandSalary (com.htsoft.oa.model.hrm.StandSalary in_standSalary) {
...
//	    	job = null;
//	    } else if (job == null) {
//	        job = new com.htsoft.oa.model.hrm.Job(aValue);
...
//	        standSalary = new com.htsoft.oa.model.hrm.StandSalary(aValue);
...
//	    }
	...
	public String getDepName() {
		return this.getDepartment() == null ? null : this.getDepartment().getDepName();
	//	return this.depName;
	}
	...
	public void setDepartment(com.htsoft.oa.model.system.Department department) {
