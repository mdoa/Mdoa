...
/**
 * FormField Base Java Bean, base class for the.oa.model, mapped directly to
 * database table
 * 
 ...
 */
public class FormField extends com.htsoft.core.model.BaseModel {
	/**
	 * 
	 */
	...
	@Expose
	protected Short status = STATUS_NOTDEL;
	transient protected com.htsoft.oa.model.flow.FormTable formTable;
	@Expose
	...
	public com.htsoft.oa.model.flow.FormTable getFormTable() {
		return formTable;
	}

	public void setFormTable(com.htsoft.oa.model.flow.FormTable in_formTable) {
	 ...
	 * * @return Long
	 * 
	 * @hibernate.id column="fieldId" type="java.lang.Long"
	...
	public Long getTableId() {
		return this.getFormTable() == null ? null : this.getFormTable()
				.getTableId();
	}
	...
	public void setTableId(Long aValue) {
		if (aValue == null) {
			...
			formTable = new com.htsoft.oa.model.flow.FormTable(aValue);
			formTable.setVersion(new Integer(0));// set a version to cheat
													// hibernate only
		} else {
			//
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="fieldName" type="java.lang.String"
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="fieldType" type="java.lang.String"
	 *                     length="128" not-null="false" unique="false"
	 */
	 ...
	 * * @return Short
	 * 
	 * @hibernate.property column="isRequired" type="java.lang.Short" length="5"
	 ...
	 * * @return Integer
	 * 
	 * @hibernate.property column="fieldSize" type="java.lang.Integer"
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="fieldDscp" type="java.lang.String"
	 ...
	 * * @return Short
	 * 
	 * @hibernate.property column="isPrimary" type="java.lang.Short" length="5"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="foreignKey" type="java.lang.String"
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="foreignTable" type="java.lang.String"
	 *                     length="64" not-null="false" unique="false"
	 */
	 ...
	 * * @return Short
	 * 
	 * @hibernate.property column="isList" type="java.lang.Short" length="5"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * * @return Short
	 * 
	 * @hibernate.property column="isQuery" type="java.lang.Short" length="5"
	 *                     not-null="false" unique="false"
	 */
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.fieldId)
				...
				.append(this.decimalLen).append(this.fieldDscp)
	...
	public String getFieldTypeDisplay() {
		if ("varchar".equals(this.fieldType)) {
			return "字符串,varchar(" + this.fieldSize + ")";
		} else if ("number".equals(this.fieldType)) {
			if (this.decimalLen == 0) {
				return "数字,number(" + this.fieldSize + ")";
			}
			return "数字,number(" + this.fieldSize + "," + this.decimalLen + ")";
