...
public class TaskSign extends com.htsoft.core.model.BaseModel {
	 ...
	 * 会签票数类型-绝对票数
	 */
	public final static Short SIGN_TYPE_COUNTS = 1;
	/**
	 * 会签票数类型-百分票数
	 */
	public final static Short SIGN_TYPE_PERCENTS = 2;

	protected Long signId;
	protected Short signType;
	protected Integer voteCounts;
	protected Integer votePercents;
	protected Short decideType;
	protected com.htsoft.oa.model.flow.ProNodeSet proNodeSet;
	...
	public com.htsoft.oa.model.flow.ProNodeSet getProNodeSet() {
		return proNodeSet;
	}

	public void setProNodeSet(com.htsoft.oa.model.flow.ProNodeSet proNodeSet) {
	...
	public Long getSetId() {
		return this.getProNodeSet() == null ? null : this.getProNodeSet()
				.getSetId();
	}
	...
	public void setSetId(Long aValue) {
		if (aValue == null) {
			proNodeSet = null;
		} else if (proNodeSet == null) {
			proNodeSet = new com.htsoft.oa.model.flow.ProNodeSet(aValue);
			proNodeSet.setVersion(new Integer(0));// set a version to cheat
			// hibernate only
		} else {
			//
			proNodeSet.setSetId(aValue);
		}
	}
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.signId, rhs.signId)
				.append(this.signType, rhs.signType)
				.append(this.voteCounts, rhs.voteCounts)
				.append(this.votePercents, rhs.votePercents)
				.append(this.decideType, rhs.decideType).isEquals();
	}
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.signId)
				.append(this.signType).append(this.voteCounts)
				.append(this.votePercents).append(this.decideType).toHashCode();
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("signId", this.signId)
				.append("signType", this.signType)
				.append("voteCounts", this.voteCounts)
				.append("votePercents", this.votePercents)
				.append("decideType", this.decideType).toString();
	}
