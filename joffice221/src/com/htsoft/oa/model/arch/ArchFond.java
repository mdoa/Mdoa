...
/**
 * ArchFond Base Java Bean, base class for the.oa.model, mapped directly to
 * database table
 * 
 ...
 */
public class ArchFond extends com.htsoft.core.model.BaseModel {
	/**
	 * 
	 */
	private static final long serialVersionUID = 8912690545191243334L;
	@Expose
	...
	@Expose
	@JsonBackReference
	protected java.util.Set<ArchRoll> archRolls = new java.util.HashSet<ArchRoll>();
	@Expose
	@JsonBackReference
	protected java.util.Set<BorrowFileList> borrowFileList = new java.util.HashSet<BorrowFileList>();
	...
	public java.util.Set<ArchRoll> getArchRolls() {
		return archRolls;
	}

	public void setArchRolls(java.util.Set<ArchRoll> in_archRolls) {
