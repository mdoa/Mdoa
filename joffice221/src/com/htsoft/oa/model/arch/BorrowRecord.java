...
/**
 * BorrowRecord Base Java Bean, base class for the.oa.model, mapped directly to
 * database table
 * 
 ...
 */
public class BorrowRecord extends com.htsoft.core.model.BaseModel {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6830828191341943559L;
	@Expose
	...
	@JsonBackReference
	protected java.util.Set<BorrowFileList> borrowFileLists = new java.util.HashSet<BorrowFileList>();
	...
	public java.util.Set<BorrowFileList> getBorrowFileLists() {
		return borrowFileLists;
	}

	public void setBorrowFileLists(
			java.util.Set<BorrowFileList> in_borrowFileLists) {
	 ...
	 * * @return Long
	 * 
	 * @hibernate.id column="recordId" type="java.lang.Long"
	 ...
	 * 
	 * @hibernate.property column="borrowDate" type="java.util.Date" length="10"
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="borrowType" type="java.lang.String"
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="borrowReason" type="java.lang.String"
	 *                     length="64" not-null="false" unique="false"
	 */
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="checkUserName" type="java.lang.String"
	 *                     length="64" not-null="false" unique="false"
	 */
	 ...
	 * * @return java.util.Date
	 * 
	 * @hibernate.property column="checkDate" type="java.util.Date" length="10"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * * @return java.util.Date
	 * 
	 * @hibernate.property column="returnDate" type="java.util.Date" length="10"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * * @return Short
	 * 
	 * @hibernate.property column="returnStatus" type="java.lang.Short"
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="borrowNum" type="java.lang.String"
	...
	public int hashCode() {
		...
		.append(this.borrowRemark).append(this.checkId).append(this.checkName)
