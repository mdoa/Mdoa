...
/**
 * ArchRoll Base Java Bean, base class for the.oa.model, mapped directly to
 * database table
 * 
 ...
 */
public class ArchRoll extends com.htsoft.core.model.BaseModel {
	/**
	 * 
	 */
	...
	@Expose
	@JsonBackReference
	protected java.util.Set<com.htsoft.oa.model.arch.RollFile> rollFiles = new java.util.HashSet<com.htsoft.oa.model.arch.RollFile>();
	...
	public java.util.Set<RollFile> getRollFiles() {
		return rollFiles;
	}

	public void setRollFiles(java.util.Set<RollFile> in_rollFiles) {
	 ...
	 * * @return Long
	 * 
	 * @hibernate.id column="rollId" type="java.lang.Long"
	...
	public void setArchFondId(Long aValue) {
		if (aValue == null) {
			...
			archFond.setVersion(new Integer(0));// set a version to cheat
												// hibernate only
		} else {
	 ...
	 * 案卷名称 * @return String
	 * 
	 * @hibernate.property column="rolllName" type="java.lang.String"
	 ...
	 * 开放形式 * @return Short
	 * 
	 * @hibernate.property column="openStyle" type="java.lang.Short" length="5"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * 
	 * @hibernate.property column="setupTime" type="java.util.Date" length="19"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * 检查人 * @return String
	 * 
	 * @hibernate.property column="checker" type="java.lang.String" length="32"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="editCompany" type="java.lang.String"
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="editDep" type="java.lang.String" length="128"
	 *                     not-null="false" unique="false"
	 */
	 ...
	 * * @return String
	 * 
	 * @hibernate.property column="decp" type="java.lang.String" length="65535"
	 *                     not-null="false" unique="false"
	 */
