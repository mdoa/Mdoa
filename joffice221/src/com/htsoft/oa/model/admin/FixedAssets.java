...
import com.htsoft.core.json.JacksonDateDeserializer;
 ...
 */
public class FixedAssets extends com.htsoft.core.model.BaseModel implements Serializable{

    /** */
	private static final long serialVersionUID = 2875184477050505735L;
	...
	protected com.htsoft.oa.model.admin.DepreType depreType;
	@JsonManagedReference
	protected com.htsoft.oa.model.admin.AssetsType assetsType;

	@JsonBackReference
	protected java.util.Set<DepreRecord> depreRecords = new java.util.HashSet<DepreRecord>();
	...
	public com.htsoft.oa.model.admin.DepreType getDepreType () {
		return depreType;
	}	
	
	public void setDepreType (com.htsoft.oa.model.admin.DepreType in_depreType) {
		this.depreType = in_depreType;
	}
	
	public com.htsoft.oa.model.admin.AssetsType getAssetsType () {
		return assetsType;
	}	
	
	public void setAssetsType (com.htsoft.oa.model.admin.AssetsType in_assetsType) {
		this.assetsType = in_assetsType;
	}

	public java.util.Set<DepreRecord> getDepreRecords () {
		return depreRecords;
	}	
	
	public void setDepreRecords (java.util.Set<DepreRecord> in_depreRecords) {
	...
	public void setAssetsTypeId(Long aValue) {
	    if (aValue==null) {
	        ...
	        assetsType = new com.htsoft.oa.model.admin.AssetsType(aValue);
	...
	public void setDepreTypeId(Long aValue) {
	    if (aValue==null) {
	        ...
	        depreType = new com.htsoft.oa.model.admin.DepreType(aValue);
