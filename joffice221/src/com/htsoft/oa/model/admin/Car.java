...
/**
 * Car Base Java Bean, base class for the.oa.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * ������������
 */
public class Car extends com.htsoft.core.model.BaseModel {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6348158935286536312L;
    ...
    @JsonBackReference
	protected Set<com.htsoft.oa.model.admin.CarApply> carApplys=new HashSet<CarApply>();
    @JsonBackReference
	protected Set<com.htsoft.oa.model.admin.CartRepair> cartRepairs=new HashSet<CartRepair>();

	public Set<com.htsoft.oa.model.admin.CarApply> getCarApplys() {
		return carApplys;
	}

	public void setCarApplys(Set<com.htsoft.oa.model.admin.CarApply> carApplys) {
		this.carApplys = carApplys;
	}

	public Set<com.htsoft.oa.model.admin.CartRepair> getCartRepairs() {
		return cartRepairs;
	}

	public void setCartRepairs(Set<com.htsoft.oa.model.admin.CartRepair> cartRepairs) {
