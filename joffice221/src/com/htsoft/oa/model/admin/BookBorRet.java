...
/**
 * BookBorRet Base Java Bean, base class for the.oa.model, mapped directly to database table
 * 
...
public class BookBorRet extends com.htsoft.core.model.BaseModel {
	...
	protected com.htsoft.oa.model.admin.BookSn bookSn;
	...
	public com.htsoft.oa.model.admin.BookSn getBookSn () {
		return bookSn;
	}	
	
	public void setBookSn (com.htsoft.oa.model.admin.BookSn in_bookSn) {
	...
	public void setBookSnId(Long aValue) {
	    if (aValue==null) {
	        ...
	        bookSn = new com.htsoft.oa.model.admin.BookSn(aValue);
