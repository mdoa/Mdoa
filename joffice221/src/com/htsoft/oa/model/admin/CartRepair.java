...
/**
 * CartRepair Base Java Bean, base class for the.oa.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * TODO: add class/table comments
 */
public class CartRepair extends com.htsoft.core.model.BaseModel {
	...
	protected com.htsoft.oa.model.admin.Car car;
	...
	public com.htsoft.oa.model.admin.Car getCar () {
		return car;
	}	
	
	public void setCar (com.htsoft.oa.model.admin.Car in_car) {
		this.car = in_car;
	}
	...
	public void setCarId(Long aValue) {
	    if (aValue==null) {
	        ...
	        car = new com.htsoft.oa.model.admin.Car(aValue);
