...
/**
 * InStock Base Java Bean, base class for the.oa.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * ������������������������������������������������������������
 */
public class InStock extends com.htsoft.core.model.BaseModel {
	...
	public void setOfficeGoods (com.htsoft.oa.model.admin.OfficeGoods in_officeGoods) {
