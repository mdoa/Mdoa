...
/**
 * Regulation Base Java Bean, base class for the.oa.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * TODO: add class/table comments
 */
public class Regulation extends com.htsoft.core.model.BaseModel {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6445620397492877281L;
	/**
	 * 状态：草稿
	 */
	...
	@JsonManagedReference
	protected java.util.Set<FileAttach> regAttachs = new java.util.HashSet<FileAttach>();
	...
	public java.util.Set<FileAttach> getRegAttachs () {
		return regAttachs;
	}	
	
	public void setRegAttachs (java.util.Set<FileAttach> in_regAttachs) {
