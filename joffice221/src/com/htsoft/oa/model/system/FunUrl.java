...
/**
 * FunUrl Base Java Bean, base class for the.oa.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * TODO: add class/table comments
 */
public class FunUrl extends com.htsoft.core.model.BaseModel {

    protected Long urlId;
	protected String urlPath;
	
	@JsonBackReference
	protected com.htsoft.oa.model.system.AppFunction appFunction;
	...
	public com.htsoft.oa.model.system.AppFunction getAppFunction () {
		return appFunction;
	}	
	
	public void setAppFunction (com.htsoft.oa.model.system.AppFunction in_appFunction) {
	...
	public void setFunctionId(Long aValue) {
	    if (aValue==null) {
	        ...
	        appFunction = new com.htsoft.oa.model.system.AppFunction(aValue);
