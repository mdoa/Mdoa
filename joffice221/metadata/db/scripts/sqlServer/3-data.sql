...
insert into mail_folder (USERID, FOLDERNAME, PARENTID, DEPLEVEL, PATH, ISPUBLIC, FOLDERTYPE)
values ( null, '收件箱', 0, 1, '0.1.', 1, 1);

insert into mail_folder (USERID, FOLDERNAME, PARENTID, DEPLEVEL, PATH, ISPUBLIC, FOLDERTYPE)
values (null, '发件箱', 0, 1, '0.2.', 1, 2);

insert into mail_folder (USERID, FOLDERNAME, PARENTID, DEPLEVEL, PATH, ISPUBLIC, FOLDERTYPE)
values (null, '草稿箱', 0, 1, '0.3.', 1, 3);

insert into mail_folder (USERID, FOLDERNAME, PARENTID, DEPLEVEL, PATH, ISPUBLIC, FOLDERTYPE)
values (null, '垃圾箱', 0, 1, '0.4.', 1, 4);
...
SET IDENTITY_INSERT form_field OFF;

SET IDENTITY_INSERT type_key ON;
...
SET IDENTITY_INSERT type_key OFF;

insert into demension values('行政维度','行政维度',1);
insert into demension values('项目维度','项目维度',2);
...
SET IDENTITY_INSERT global_type ON;
...
SET IDENTITY_INSERT global_type OFF;


/**==== 流水号数据=========***/
SET IDENTITY_INSERT serial_number ON;
...
SET IDENTITY_INSERT serial_number OFF;
